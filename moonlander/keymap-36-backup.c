...
[0] = LAYOUT_moonlander(
        ...
        _______,   _______,   _______,   _______,  KR_0_4_1,  KR_0_4_2,                        KR_0_4_5,  KR_0_4_6,  _______,   _______,    _______,    _______,
        MEH(KC_X), _______,   _______,   _______,   _______,   _______,                      _______,   _______,   _______,   _______,   _______,    _______,
                                                  KR_0_4_3, _______, _______,    _______, _______, KR_0_4_4
    ),
    ...
    [1] = LAYOUT_moonlander(
        ...
        _______, _______,   _______,   _______,  KR_1_4_1,  KR_1_4_2,                         KR_1_4_5,  KR_1_4_6,  _______,   _______,    _______,    _______,
        _______, _______,   _______,   _______,   _______,   _______,                         _______,   _______,   _______,   _______,   _______,    _______,
                                                  KR_1_4_3, _______, _______,    _______, _______, KR_1_4_4
    ),
    ...
    [2] = LAYOUT_moonlander(
        ...
        _______, _______,   _______,   _______,  KR_2_4_1,  KR_2_4_2,                         KR_2_4_5,  KR_2_4_6,  _______,   _______,    _______,    _______,
        _______, _______,   _______,   _______,   _______,   _______,                         _______,   _______,   _______,   _______,   _______,    _______,
                                                  KR_2_4_3, _______, _______,    _______, _______, KR_2_4_4
    ),
    ...
    [3] = LAYOUT_moonlander(
        ...
        _______, _______,   _______,   _______,  KR_3_4_1,  KR_3_4_2,                         KR_3_4_5,  KR_3_4_6,  _______,   _______,    _______,    _______,
        _______, _______,   _______,   _______,   _______,   _______,                         _______,   _______,   _______,   _______,   _______,    _______,
                                                  KR_3_4_3, _______, _______,    _______, _______, KR_3_4_4
    ),
    ...
    [4] = LAYOUT_moonlander(
        ...
        _______, _______,   _______,   _______,  KR_4_4_1,  KR_4_4_2,                         KR_4_4_5,  KR_4_4_6,  _______,   _______,    _______,    _______,
        _______, _______,   _______,   _______,   _______,   _______,                         _______,   _______,   _______,   _______,   _______,    _______,
                                                  KR_4_4_3, _______, _______,    _______, _______, KR_4_4_4
    )
};