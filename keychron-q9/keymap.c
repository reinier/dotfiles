...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_52(
        ...
        OSM(MOD_LCTL), OSM(MOD_LALT),  OSM(MOD_LGUI),              LT(_FN3,KC_SPC),                      OSM(MOD_RGUI),  TO(_FN1), TO(_FN3), KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [_FN1] = LAYOUT_ansi_52(
        ...
        _______, _______,  _______,                             _______,                            _______,  TO(MAC_BASE),  TO(_FN3),  _______, _______, _______),

    [_FN3] = LAYOUT_ansi_52(
        KC_TILD,  KC_1,     KC_2,     KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,     KC_MINS,  KC_EQL,          KC_BSLS,          _______,
        KC_CAPS, KC_F1,    KC_F2,    KC_F3,   KC_F4,   KC_F5,   KC_F6,      _______,  _______, _______, _______, _______, _______,          TO(MAC_BASE),
        _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_F11,   KC_F12, _______, _______, _______,  _______,            _______, _______,
        _______, _______,  _______,                             _______,                            _______,  TO(_FN1),  TO(MAC_BASE),  _______, _______, _______),
